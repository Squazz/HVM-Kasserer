...
class Program
{
    ...
    private static string bankPosteringerFilepath = @"C:\Users\kaspe\Downloads\eksport.csv";

    static string exclusionsFilePath = @"D:\Dropbox\HVM - Kasserer\Program-kode\HVM Kasserer\mobilePayExclusions.txt";
    static string matchesFilePath = @"D:\Dropbox\HVM - Kasserer\Program-kode\HVM Kasserer\cprToAddressMatches.xlsx";

    static List<string> mobilePayExclusions = LoadExclusionsFromFile();
    static List<CprToSenderMatch> cprToSenderMatches = LoadMatchesFromFile();
    ...
    static void Main()
    {
        var test = cprToSenderMatches;
        HandleBankPosteringer();
        SummarizeMobilePayTransactions();
    }

    private static void HandleBankPosteringer()
    {
